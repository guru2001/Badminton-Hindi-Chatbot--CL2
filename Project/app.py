...
def bot(query):
	...
	if human_text not in exit:
	    if human_text == 'शुक्रिया':
	        return("बैडमिंटन चैम्प: यह तो मेरा बड़प्पन है")
	    else:
	        if human_text == 'नमस्कार' or human_text == 'नमस्कार ।':
		        return("बैडमिंटन चैम्प: " + generate_greeting_response(human_text))
	        else:
		        return("बैडमिंटन चैम्प: " + generate_response(human_text))
		        article_sentences.remove(human_text)
	else:
		
		return("बैडमिंटन चैम्प: अलविदा")
app = Flask(__name__)
